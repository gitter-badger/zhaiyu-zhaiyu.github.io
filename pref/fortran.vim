...
if b:fortran_fixed_source == 1
	set colorcolumn=6,73     "syntaxhighlight, in fixed format, the 6th column is for adding character 
	                         "and the 73rd and the following columns should not contain useful codes 
endif
